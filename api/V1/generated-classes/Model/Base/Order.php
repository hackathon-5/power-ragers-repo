...
abstract class Order implements ActiveRecordInterface
{
    ...
    /**
     * The value for the truck_id field.
     * @var        int
     */
    protected $truck_id;
    ...
    /**
     * The value for the customer_phone_number field.
     * @var        string
     */
    ...
    /**
     * Get the [customer_phone_number] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [truck_id] column.
     *
     * @param int $v new value
     * @return $this|\Model\Order The current object (for fluent API support)
     */
    public function setTruckId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->truck_id !== $v) {
            $this->truck_id = $v;
            $this->modifiedColumns[OrderTableMap::COL_TRUCK_ID] = true;
        }

        if ($this->aTruck !== null && $this->aTruck->getId() !== $v) {
            $this->aTruck = null;
        }
    ...
    public function setItemName($v)
    {
        ...
        if ($this->item_name !== $v) {
            $this->item_name = $v;
            $this->modifiedColumns[OrderTableMap::COL_ITEM_NAME] = true;
        }
    ...
    public function setCustomerName($v)
    {
        ...
        if ($this->customer_name !== $v) {
            ...
            $this->modifiedColumns[OrderTableMap::COL_CUSTOMER_NAME] = true;
        }
    ...
    public function setCustomerEmail($v)
    {
        ...
        if ($this->customer_email !== $v) {
            ...
            $this->modifiedColumns[OrderTableMap::COL_CUSTOMER_EMAIL] = true;
        }
    ...
    /**
     * Set the value of [customer_phone_number] column.
     *
     * @param string $v new value
     * @return $this|\Model\Order The current object (for fluent API support)
     */
    public function setCustomerPhoneNumber($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->customer_phone_number !== $v) {
            $this->customer_phone_number = $v;
            $this->modifiedColumns[OrderTableMap::COL_CUSTOMER_PHONE_NUMBER] = true;
        }
    ...
    /**
     * Sets the value of the [open] column.
    ...
    public function setOpen($v)
    {
        ...
        if ($this->open !== $v) {
            $this->open = $v;
            $this->modifiedColumns[OrderTableMap::COL_OPEN] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OrderTableMap::translateFieldName('TruckId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->truck_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OrderTableMap::translateFieldName('ItemName', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    {
        if ($this->aTruck !== null && $this->truck_id !== $this->aTruck->getId()) {
            $this->aTruck = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aTruck !== null) {
                if ($this->aTruck->isModified() || $this->aTruck->isNew()) {
                    $affectedRows += $this->aTruck->save($con);
                }
                $this->setTruck($this->aTruck);
            }
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aTruck) {
                ...
                $result[$key] = $this->aTruck->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrderTableMap::COL_TRUCK_ID)) {
            $criteria->add(OrderTableMap::COL_TRUCK_ID, $this->truck_id);
        }
        if ($this->isColumnModified(OrderTableMap::COL_ITEM_NAME)) {
            $criteria->add(OrderTableMap::COL_ITEM_NAME, $this->item_name);
        }
        if ($this->isColumnModified(OrderTableMap::COL_PRICE)) {
        ...
        if ($this->isColumnModified(OrderTableMap::COL_CUSTOMER_EMAIL)) {
            $criteria->add(OrderTableMap::COL_CUSTOMER_EMAIL, $this->customer_email);
        }
        if ($this->isColumnModified(OrderTableMap::COL_CUSTOMER_PHONE_NUMBER)) {
            $criteria->add(OrderTableMap::COL_CUSTOMER_PHONE_NUMBER, $this->customer_phone_number);
        }
        if ($this->isColumnModified(OrderTableMap::COL_OPEN)) {
            $criteria->add(OrderTableMap::COL_OPEN, $this->open);
        }
        if ($this->isColumnModified(OrderTableMap::COL_CREATED_AT)) {
    ...
    /**
     * Get the associated ChildTruck object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildTruck The associated ChildTruck object.
     * @throws PropelException
     */
    public function getTruck(ConnectionInterface $con = null)
    {
        if ($this->aTruck === null && ($this->truck_id !== null)) {
            $this->aTruck = ChildTruckQuery::create()->findPk($this->truck_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTruck->addOrders($this);
             */
        }
