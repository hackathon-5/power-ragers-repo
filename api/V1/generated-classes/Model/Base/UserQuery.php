 ...
 * @method     ChildUserQuery orderByPassword($order = Criteria::ASC) Order by the password_hash column
 ...
 * @method     ChildUserQuery groupByPassword() Group by the password_hash column
 ...
 *
 * @method     ChildUserQuery leftJoinAccessToken($relationAlias = null) Adds a LEFT JOIN clause to the query using the AccessToken relation
 * @method     ChildUserQuery rightJoinAccessToken($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AccessToken relation
 * @method     ChildUserQuery innerJoinAccessToken($relationAlias = null) Adds a INNER JOIN clause to the query using the AccessToken relation
 *
 * @method     ChildUserQuery joinWithAccessToken($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the AccessToken relation
 *
 * @method     ChildUserQuery leftJoinWithAccessToken() Adds a LEFT JOIN clause and with to the query using the AccessToken relation
 * @method     ChildUserQuery rightJoinWithAccessToken() Adds a RIGHT JOIN clause and with to the query using the AccessToken relation
 * @method     ChildUserQuery innerJoinWithAccessToken() Adds a INNER JOIN clause and with to the query using the AccessToken relation
 *
 * @method     ChildUserQuery leftJoinTruck($relationAlias = null) Adds a LEFT JOIN clause to the query using the Truck relation
 * @method     ChildUserQuery rightJoinTruck($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Truck relation
 * @method     ChildUserQuery innerJoinTruck($relationAlias = null) Adds a INNER JOIN clause to the query using the Truck relation
 *
 * @method     ChildUserQuery joinWithTruck($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Truck relation
 *
 * @method     ChildUserQuery leftJoinWithTruck() Adds a LEFT JOIN clause and with to the query using the Truck relation
 * @method     ChildUserQuery rightJoinWithTruck() Adds a RIGHT JOIN clause and with to the query using the Truck relation
 * @method     ChildUserQuery innerJoinWithTruck() Adds a INNER JOIN clause and with to the query using the Truck relation
 *
 * @method     \Model\AccessTokenQuery|\Model\TruckQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUser findOneByPassword(string $password_hash) Return the first ChildUser filtered by the password_hash column
 ...
 * @method     ChildUser requireOneByPassword(string $password_hash) Return the first ChildUser filtered by the password_hash column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUser[]|ObjectCollection findByPassword(string $password_hash) Return ChildUser objects filtered by the password_hash column
...
abstract class UserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'truckyeah', $modelName = '\\Model\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, email, password_hash, created_at, updated_at FROM users WHERE id = :p0';
        try {
     ...
     * Example usage:
     * <code>
     * $query->filterByPassword('fooValue');   // WHERE password_hash = 'fooValue'
     * $query->filterByPassword('%fooValue%'); // WHERE password_hash LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByPassword($password = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_PASSWORD_HASH, $password, $comparison);
    }
    ...
    public function filterByAccessToken($accessToken, $comparison = null)
    {
        if ($accessToken instanceof \Model\AccessToken) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $accessToken->getUserId(), $comparison);
        } elseif ($accessToken instanceof ObjectCollection) {
            return $this
                ->useAccessTokenQuery()
                ->filterByPrimaryKeys($accessToken->getPrimaryKeys())
                ->endUse();
        } else {
    ...
    /**
     * Adds a JOIN clause to the query using the AccessToken relation
     *
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function joinAccessToken($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('AccessToken');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'AccessToken');
        }
    ...
    /**
     * Use the AccessToken relation AccessToken object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Model\AccessTokenQuery A secondary query class using the current class as primary query
     */
    public function useAccessTokenQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAccessToken($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'AccessToken', '\Model\AccessTokenQuery');
    }
    ...
    public function filterByTruck($truck, $comparison = null)
    {
        if ($truck instanceof \Model\Truck) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $truck->getUserId(), $comparison);
        } elseif ($truck instanceof ObjectCollection) {
            return $this
                ->useTruckQuery()
                ->filterByPrimaryKeys($truck->getPrimaryKeys())
                ->endUse();
        } else {
